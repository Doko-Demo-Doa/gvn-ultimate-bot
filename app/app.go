...
func Run() {
	...
	*/
	...
	discordRoleReactionEmbedService := discordservice.NewDiscordRoleReactionEmbedService(discordRoleReactionEmbedRepo, discordUserRepo, discordRepo, systemEventLogService, s, guildID)
	...
	discord.POST("/role/sync", discordRoleCtl.SyncDiscordRoles)
	discord.GET("/role/sync/last", discordRoleCtl.GetLastRoleSync)
